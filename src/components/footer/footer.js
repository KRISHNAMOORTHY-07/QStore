...
import Logo from '../../assets/images/Q-Store logo.png';
                ...
                <div className='container-fluid'>
                    <div className='box d-flex align-items-center'>
                        <div className='info'>
                            ...
                            <p>Start You'r Daily Shopping with Q Store</p>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: Tirupattur</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+91) - 540-025-124553 </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> qgc@gmail.com</p>
